...
public interface ServerProto {
  ...
  java.lang.CharSequence get_fridge_port(int uid) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends ServerProto {
    ...
    void get_fridge_port(int uid, org.apache.avro.ipc.Callback<java.lang.CharSequence> callback) throws java.io.IOException;
  }
}
